                ...
                <article id="main-col">
                    ...
                    <ul id="services">
                        ...
                        <li><h3>Norse Map View</h3>
                            ...
                            <a href="http://map.norsecorp.com/#/" target="_blank"><p>click here to see</p></a>
                        </li>
                    </ul>
                </article>
            ...
            <aside id='sidebar'>
                <div class="dark">
                    ...
                    <form action='config.php' method="post" class="quote" enctype="multipart/form-data">
                        <p>Thanks. we have successfully received your message.</p>
                    </form>
            </aside>
</div>
        </section>
...
$sql = "INSERT INTO nidhi (name, email, message)
